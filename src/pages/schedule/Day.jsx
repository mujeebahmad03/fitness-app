...
function Day() {
  ...
  const selectedDay = scheduleData.find(
    (item) => item.day.toLowerCase() === str
  );
        ...
        <div className="flex flex-col gap-3">
          {selectedDay.classes.map((classInfo, index) => (
            ...
            >
              ...
              <li className="py-[25px] lg:px-[55px] bg-[#f2f2f2] w-full  min800:justify-center items-center flex justify-end">
                <Join />
              </li>
            </ul>
          ))}
